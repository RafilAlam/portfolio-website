        ...
        <nav className="flex items-center justify-between w-full">
            ...
            <div id="nav-pill-wrapper" className="">
                ...
                <div id="nav-pill" ref={pill} className="flex bg-[#f2f2f20d] backdrop-blur-md border border-[#f2f2f21a] rounded-4xl p-1 pl-[6] pr-[6] gap-2 shadow-[0_10px_25px_#00000026] hover:shadow-[0_15px_40px_#0000004d] hover:border-[#f2f2f233] hover:bg-[#f2f2f214] [transition:border-color_.6s_cubic-bezier(.165,.84,.44,1),_box-shadow_1s_cubic-bezier(.23,1,.32,1)]">
                    ...
                    <div onClick={() => tab2click("/info")} className="bg-transparent border-inherit rounded-4xl text-[15px] text-center p-2 pl-6 pr-6 hover:bg-[linear-gradient(to_right,_#0000,_#f2f2f20d)]">Info</div>
            ...
            <div id="nav-right-wrapper" className="">
                    ...
                    <div id="mobile-menu" ref={mobilenavmenu} className="flex flex-col absolute scale-0 opacity-0 z-10 backdrop-blur-[20px] bg-[#f2f2f20d] border-[1px] border-[#f2f2f21a] rounded-[16px] w-[160px] p-[8px] top-[88px] right-[24px] overflow-hidden shadow-[0_10px_30px_#0000004d]">
                        <a href="https://www.linkedin.com/in/rafil-alam-973759364/" target="_blank" ref={linkedinref} className="flex text-[14px] justify-between tracking-wider font-normal py-[12px] px-[14px] gap-[4px] rounded-[24px] hover:bg-[#f2f2f20d] transition-colors duration-300 ease-[cubic-bezier(.165,.84,.44,1)]">
                        ...
                        <a href="https://github.com/RafilAlam" target="_blank" ref={githubref} className="flex text-[14px] justify-between tracking-wider font-normal py-[12px] px-[14px] gap-[4px] rounded-[24px] hover:bg-[#f2f2f20d] transition-colors duration-300 ease-[cubic-bezier(.165,.84,.44,1)]">
