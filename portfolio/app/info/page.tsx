...
export default function Home() {
  ...
  return (
      <div id="body" className="min-h-screen bg-radial-[circle_closest-corner_at_50%_0,_#f2f2f226,_#0000]">
        <div id="section-nav" className="z-10 flex fixed w-full pt-[24px] pl-[48px] pr-[48px] bg-linear-[#0006,#0000]">
              <Navbar tab="2" />
        </div>
        <div id="smooth-scroll">
          <div id="smooth-content">
            <div id="section-about" className="flex flex-col relative gap-[80px] z-1 pt-[160px] pb-[120px] pl-[48px] pr-[48px] justify-center relative">
            ...
            <div id="section-experience" className="flex flex-col pt-[72px] pb-[120px] relative z-1 gap-[56px] items-center">
              <div id="content" className="flex flex-col gap-[64px] align-start w-[882px]">
                ...
                <div id="block" className="grid gap-x-[48px] gap-y-[16px] justify-between grid-cols-2">
                  ...
                  <div id="content-experience" className="flex flex-col gap-[20px] pt-0">
                    ...
                    <div id="body-info" className="flex-1 leading-[150%] font-light text-[16px] text-[#f2f2f299]">I ran Tinkers' Club and managed activities for members.</div>
                  </div>
                </div>
              </div>
            </div>
